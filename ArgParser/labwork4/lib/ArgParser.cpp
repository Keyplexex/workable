...
ArgParser::StringArgument& ArgParser::AddStringArgument(char shorter, const std::string& longer, const std::string& description) {
...
ArgParser::IntArgument& ArgParser::AddIntArgument(char shorter, const std::string& longer, const std::string& description) {

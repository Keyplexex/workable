...
public class OrderController {
    ...
    @PatchMapping("/{id}/warehouse/approve")
    @PreAuthorize("hasRole('WAREHOUSE_ADMIN')")
    @Operation(summary = "Согласовать заказ со складом")
    public ResponseEntity<Order> approveWarehouse(@PathVariable UUID id) {
        return ResponseEntity.ok(orderService.updateOrderStatus(id, OrderStatus.WAREHOUSE_APPROVED));
    }
